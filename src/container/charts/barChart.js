...
const data = [
    { name: 'food', amt: 4500, time: 1, uvError: [100, 50], pvError: [110, 20] },
    { name: 'cosmetic', amt: 6500, time: 2, uvError: 120, pvError: 50 },
    { name: 'storage', amt: 5000, time: 3, uvError: [120, 80], pvError: [200, 100] },
    { name: 'digital', amt: 4000, time: 4, uvError: 100, pvError: 30 },
];
